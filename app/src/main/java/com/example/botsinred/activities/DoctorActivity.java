...
import com.example.botsinred.fragments.GraphFragment;
...
public class DoctorActivity extends AppCompatActivity implements FirebaseAuth.AuthStateListener{
    ...
    private void setupBottomBar() {
        ...
        bottomNavigation.add(new MeowBottomNavigation.Model(3, R.drawable.icon_medical));
